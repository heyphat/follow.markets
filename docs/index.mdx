...
4. Market signal source path: `market.evaluator.signal.source_path`. Place your signals into this directory before deployment. There is another way to add signals to the system, visit the [docs](https://docs.follow.markets) for more information.
