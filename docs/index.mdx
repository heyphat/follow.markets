...
If you use amd64-based machine or want to build it from the source code, run the `bash scripts/build` to build docker image.
...
2. The market components & APIs 
    1. [Watcher](https://docs.follow.markets/followmarkets/watcher)
    2. [Evaluator](https://docs.follow.markets/followmarkets/evaluator)
    3. [Streamer](https://docs.follow.markets/followmarkets/streamer)
    4. [Notifier](https://docs.follow.markets/followmarkets/notifier)
    5. [Tetster](https://docs.follow.markets/followmarkets/tester)
3. Indicators
