...
This part discusses only the mandatory variables in the `configs/configs.json` file. For more information, refer to the docs [here](https://docs.follow.markets/followmarkets/configuration).
...
2. Market notifier bot: 
    ...
    2. `market.notifier.telegram.bot_password` this password is to prevent other to access your bot. You can set it to anything, the bot will ask for authorization when you talk to it.
