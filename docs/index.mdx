...
If you use arm64-based machine or want to build it from the source code, run the `bash scripts/build` to build docker image.

After the application deployment, you should be able to call to check on the watchlist via the watcher [APIs](https://docs.follow.markets/market-components-and-apis/watcher#get-the-list-of-runners-that-being-watched-from-the-watcher).

# Configuration

This part discusses only the mandatory environment variables in the `configs/configs.json` file. For more information, refer to the docs [here](https://docs.follow.markets/followmarkets/configuration).
...
# More docs 
1. [Configuration](https://docs.follow.markets/followmarkets/configuration)
2. The market components & APIs 
    1. [Watcher](https://docs.follow.markets/market-components-and-apis/watcher)
    2. [Evaluator](https://docs.follow.markets/market-components-and-apis/evaluator)
    4. [Notifier](https://docs.follow.markets/market-components-and-apis/notifier)
    5. [Tetster](https://docs.follow.markets/market-components-and-apis/tester)
3. Other concepts 
    1. [Signal](https://docs.follow.markets/other-concepts/signal)
    2. [Strategy](https://docs.follow.markets/other-concepts/strategy)
